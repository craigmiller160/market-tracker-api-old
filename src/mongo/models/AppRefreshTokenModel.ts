...
export const AppRefreshTokenModel = model<AppRefreshToken>('app_refresh_token', appRefreshTokenSchema);
...
export const appRefreshTokenToModel = (appRefreshToken: AppRefreshToken): AppRefreshTokenModelInstanceType =>
